...
public class CC {
	...
	static {
		...
		CHAT_BAR_CUSTOM_COLOR = ChatColor.STRIKETHROUGH.toString() + "---------------------------------";
	...
	public static String getNextRainbowColor(String color) {
		if (color.equals(CC.RED)) {
			return CC.GOLD;
		} else if (color.equals(CC.GOLD)) {
			return CC.YELLOW;
		} else if (color.equals(CC.YELLOW)) {
			return CC.GREEN;
		} else if (color.equals(CC.GREEN)) {
			return CC.AQUA;
		} else if (color.equals(CC.AQUA)) {
			return CC.PINK;
		} else if (color.equals(CC.PINK)) {
			return CC.DARK_PURPLE;
		} else if (color.equals(CC.DARK_PURPLE)) {
			return CC.RED;
		} else return CC.WHITE;
	}
